...
import 'package:money_management/Widgets/chart/ChartBar.dart';
...
class TxChart extends StatelessWidget {
  ...
  List<Map<String, dynamic>> get groupedTxValues {
    return List.generate(7, (index) {
      ...
      return {'day': DateFormat(DateFormat.ABBR_WEEKDAY).format(weekDays), 'amount': totalTx};
    }).reversed.toList();
  }
